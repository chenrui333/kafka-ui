...
[rbac-role-based-access-control](../configuration/rbac-role-based-access-control/index.md "mention")
...
See the [LDAP compose example](https://github.com/chenrui333/kafka-ui/blob/main/documentation/compose/ldap.yaml).
...
Yes, you can. Swagger declaration is located [here](https://github.com/chenrui333/kafka-ui/blob/main/kafka-ui-contract/src/main/resources/swagger/kafka-ui-api.yaml).
