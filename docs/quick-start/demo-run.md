...
4. Go to [http://localhost:8080/ui/clusters/create-new-cluster](http://localhost:8080/ui/clusters/create-new-cluster) and configure your first cluster by pressing on `Configure new cluster`.
