...
* [Download the latest kafka-ui jar file](https://github.com/chenrui333/kafka-ui/releases)
...
* Example of how to configure clusters in the [application-local.yml](https://github.com/chenrui333/kafka-ui/blob/main/kafka-ui-api/src/main/resources/application-local.yml) configuration file.
