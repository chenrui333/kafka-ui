...
The first is to browse the repository's open issues directly and look for work that matches your area of interest.

* [Open issues](https://github.com/chenrui333/kafka-ui/issues)
* [Issues labeled `accepted`](https://github.com/chenrui333/kafka-ui/issues?q=is%3Aissue+is%3Aopen+label%3Aaccepted)
* [Issues labeled `scope/frontend`](https://github.com/chenrui333/kafka-ui/issues?q=is%3Aissue+is%3Aopen+label%3Ascope%2Ffrontend)
* [Issues labeled `scope/backend`](https://github.com/chenrui333/kafka-ui/issues?q=is%3Aissue+is%3Aopen+label%3Ascope%2Fbackend)

The second option is to search for ["good first issue"](https://github.com/chenrui333/kafka-ui/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)-labeled issues.
...
Every issue “in progress” needs to be assigned to a corresponding person so the current owner is clear to everyone following the work.

### Setting up a local development environment

Please refer to the [build prerequisites](building/prerequisites.md) and [local build guides](building/index.md).
